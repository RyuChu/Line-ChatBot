...
def handle_message(event):
    ...
    introMsg = "I am a person who has a high willingness to learn, work and do everythin positively. Being a calm man who will use time to learn. To gain more experience, knowledge and self-ability through internships during my studies."
    ...
    elif event.message.text.lower() == "education":
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text=eduMsg))
    elif event.message.text.lower() == "experience":
